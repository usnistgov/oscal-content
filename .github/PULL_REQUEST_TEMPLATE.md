...
### Changes to OSCAL artifact examples:
All examples should be in XML in the src directory. The XML, JSON, and YAML release versions are generated by the CI/CD pipeline, which performs all necessary validations.
- [ ] Are your changes in XML?
- [ ] Are your changes in the src directory?
