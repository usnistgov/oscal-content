...
<!-- when the head is incremented, it should be calculable relative to other
    ...
    <xsl:template mode="number-format" priority="3" match="oscal:part[@name='item']/oscal:part[@name='item']/oscal:part[@name='item']">(a)</xsl:template>
    <xsl:template mode="number-format" priority="4" match="oscal:control/oscal:control//oscal:part[@name='item']">(a)</xsl:template>
    <xsl:template mode="number-format" priority="5" match="oscal:control/oscal:control//oscal:part[@name='item']/oscal:part[@name='item']">(1)</xsl:template>
